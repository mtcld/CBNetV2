    ...
    def _resize_img(self, results):
        ...
        for key in results.get('img_fields', ['img']):
            if self.keep_ratio:
                ...
                #print('debug  resize  : ',img.shape,results[key].shape)
    ...
    def _pad_img(self, results):
        ...
        for key in results.get('img_fields', ['img']):
            ...
            if self.size is not None:
                #print('debug : ',results[key].shape,self.size,pad_val)
...
class RandomCrop:
    ...
    def __call__(self, results):
        ...
        #print('debug crop : ',crop_size,'image size : ',image_size,'output : ',results['img_shape'])
        return results
