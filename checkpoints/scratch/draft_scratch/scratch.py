...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                entity='hangphan',
                project='scratch_hyperparams_tuning_draft',
                name='opt_method:AdamW, lr:0.0001, grad_clip:None ',
                tags='scratch_baseline'),
            interval=50,
            log_checkpoint=True,
...
workflow = [('train', 1)]
fp16 = None
work_dir = '/mmdetection/checkpoints/scratch/draft_scratch'
gpu_ids = range(0, 2)
