...
model = dict(
    ...
    rpn_head=dict(
        ...
        anchor_generator=dict(
            ...
            ratios=[0.3434203, 0.94352366, 1.92110634, 3.7757587, 7.58430032],
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        classes=['scratch'],
        ann_file='data/scratch/annotations/clean_train_8k.json',
...
load_from = '/mmdetection/checkpoints/scratch/demo_scratch_v13/epoch_29.pth'
resume_from = None
workflow = [('train', 1)]
fp16 = None
work_dir = '/mmdetection/checkpoints/scratch/demo_scratch_v16'
gpu_ids = range(0, 2)
