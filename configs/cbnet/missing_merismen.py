...
data_root = 'data/combine_missing/'
img_norm_cfg = dict(
...
pseudo_pipeline = [
    ...
    dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
    dict(type='RandomFlip', flip_ratio=0.5),
    dict(type='Rotate',level=3,prob=0.5,max_rotate_angle=20),
    dict(
        type='Albu',
        transforms=albu_pseudo_transforms,
        bbox_params=dict(
            type='BboxParams',
            format='pascal_voc',
            label_fields=['gt_labels'],
...
pseudo_merimen_train = dict(
    ...
    dataset=dict(
        ...
        classes=classes,
        test_mode=False,
        ann_file=data_root+'../merimen_coco/09_09/combine_missing/annotations/post_pseudo.json',
        img_prefix=data_root+'../merimen_coco/09_09/combine_missing/images/',
...
workflow = [('train', 1)]
fp16 = None
work_dir = './work_dirs/pseudo_missing'
gpu_ids = range(0, 2)
