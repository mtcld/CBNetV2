...
dataset_merimen_mask_train = dict(
    ...
    dataset=dict(
        ...
        classes=classes,
        test_mode=False,
        ann_file=data_root+'../merimen_coco/26_8_mask/crack_broken/annotations/clean_total.json',
        img_prefix=data_root+'../merimen_coco/26_8_mask/crack_broken/images/',
...
dataset_merimen_pseudo_train = dict(
    ...
    dataset=dict(
        ...
        classes=classes,
        test_mode=False,
        ann_file=data_root+'../merimen_coco/26_8/combine_crack/annotations/post_pseudo.json',
        img_prefix=data_root+'../merimen_coco/26_8/combine_crack/images/',
...
workflow = [('train', 1)]
fp16 = None
work_dir = './work_dirs/combine_crack_phase_2'
gpu_ids = range(0, 2)
